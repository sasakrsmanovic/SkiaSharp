import { config as unoConfig } from "/SkiaSharp/staging/3836/fiddle/package_c8a384c05416d6da538f06f23408d037c31057f6/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('70d40223-1b84-47d7-8eb8-ceefd0470e11').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '70d40223-1b84-47d7-8eb8-ceefd0470e11';
