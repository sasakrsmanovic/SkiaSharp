import { config as unoConfig } from "/SkiaSharp/staging/3900/fiddle/package_c8a384c05416d6da538f06f23408d037c31057f6/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('2e6fa8e3-07f1-48a4-9a4b-4de7e5fa76c0').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '2e6fa8e3-07f1-48a4-9a4b-4de7e5fa76c0';
