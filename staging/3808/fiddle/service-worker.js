import { config as unoConfig } from "/SkiaSharp/staging/3808/fiddle/package_c8a384c05416d6da538f06f23408d037c31057f6/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('91a41dd0-c7e2-4bba-8bd7-00d1dea3a164').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '91a41dd0-c7e2-4bba-8bd7-00d1dea3a164';
