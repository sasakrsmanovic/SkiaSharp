import { config as unoConfig } from "/SkiaSharp/staging/3787/fiddle/package_55723929254a902d2b3f20ecf88de47ceb5e9597/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('d27f2363-e077-45bb-9f54-157307ff10d7').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'd27f2363-e077-45bb-9f54-157307ff10d7';
