import { config as unoConfig } from "/SkiaSharp/staging/3783/fiddle/package_55723929254a902d2b3f20ecf88de47ceb5e9597/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('cadcab95-6d5a-424e-af00-05974ea1c3ed').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'cadcab95-6d5a-424e-af00-05974ea1c3ed';
