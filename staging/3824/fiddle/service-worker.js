import { config as unoConfig } from "/SkiaSharp/staging/3824/fiddle/package_c8a384c05416d6da538f06f23408d037c31057f6/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('afc9c0d4-aba6-4180-8791-e8c7416937c7').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'afc9c0d4-aba6-4180-8791-e8c7416937c7';
